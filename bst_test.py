...
#     '''
    ...
    def test_insert(self):
        ...
        bst.insert(50)
        self.assertEqual(bst.root.right.right.key, 50)
        bst.insert(20)
        self.assertEqual(bst.root.left.right.key, 20)
        bst.insert(40)
        self.assertEqual(bst.root.right.right.left.key, 40)
        bst.insert(70)
        self.assertEqual(bst.root.right.right.right.key, 70)
        bst.insert(60)
        self.assertEqual(bst.root.right.right.right.left.key, 60)
    ...
    def test_min_value_node(self):
        bst = BSTree()
        bst.insert(3)
        self.assertEqual(bst._min_value_node(bst.root).key, 3)
        bst.insert(2)
        self.assertEqual(bst._min_value_node(bst.root).key, 2)
        bst.insert(1)
        self.assertEqual(bst._min_value_node(bst.root).key, 1)
